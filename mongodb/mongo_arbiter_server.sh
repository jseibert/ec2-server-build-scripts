#!/bin/bash -x
## Mongo Arbiter Server Build Script
##  Prerequisites:
...
description "MongoDB Arbiter Server"
...
exec start-stop-daemon --start --quiet --chuid mongodb --exec  /usr/bin/mongod -- --replSet crashset --dbpath /data/db/mongodb --logpath /data/db/mongodb.log --logappend
EOF
